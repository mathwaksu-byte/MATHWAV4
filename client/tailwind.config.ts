  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        page-gradient:
          'linear-gradient(180deg, rgba(245,247,255,0.9) 0%, rgba(255,255,255,1) 100%), radial-gradient(1200px 600px at 15% 10%, rgba(30,64,175,0.20), transparent), radial-gradient(1400px 700px at 85% 90%, rgba(59,130,246,0.18), transparent)',
      },
      boxShadow: {
